  ...
  <div class="page indexPage" >
    ...
    <div class="page-content hasTopTabs">
      <div class="cont" v-if="tabIndex != 0">
        ...
        :pullUpLoad="infiniteCount < currentCount" @pullingUp="pullingUp" v-if="contData.length > 0 && tabIndex != 0">
          <router-link :to="'/goodsDetail/' + cont.skuId" tag="dl" class="infoData" v-for="cont in contData" :key="cont.skuId">
            ...
            <dd>
              ...
              <div class="price">
                ...
                <p class="selling" :class="{sellingAdd: appUserType != 'notLogin'}" v-if="appUserType == 'notLogin' || appUserType == 'GENERAL'">零售价：<span>￥{{cont.originalPrice | twoDecimal}}</span></p>
              </div>
            </dd>
          </router-link>
        </mr-better-scroll>
      ...
      <div class="cont" v-if="tabIndex == 0">
        ...
        :pullDownRefresh="true" @pullingDown="pullingDown"
        :pullUpLoad="pullUpLoad" @pullingUp="pullingUp" v-if="tabIndex == 0">
